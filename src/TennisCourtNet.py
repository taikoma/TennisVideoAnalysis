...
class TennisCourtNet(nn.Module):
    def __init__(self):
        ...
        # Featureモジュール
        self.model0 = TennisCourt_Feature()

        # Stageモジュール
        # PAFs（Part Affinity Fields）側
        self.model1_1 = make_TennisCourt_block('block1_1')
        self.model2_1 = make_TennisCourt_block('block2_1')
        self.model3_1 = make_TennisCourt_block('block3_1')
        self.model4_1 = make_TennisCourt_block('block4_1')
        self.model5_1 = make_TennisCourt_block('block5_1')
        self.model6_1 = make_TennisCourt_block('block6_1')

        # confidence heatmap側
        self.model1_2 = make_TennisCourt_block('block1_2')
        self.model2_2 = make_TennisCourt_block('block2_2')
        self.model3_2 = make_TennisCourt_block('block3_2')
        self.model4_2 = make_TennisCourt_block('block4_2')
        self.model5_2 = make_TennisCourt_block('block5_2')
...
class TennisCourt_Feature(nn.Module):
    def __init__(self):
        super(TennisCourt_Feature, self).__init__()
...
def make_TennisCourt_block(block_name):
    ...
    blocks['block1_1'] = [{'conv5_1_CPM_L1': [128, 128, 3, 1, 1]},
                          ...
                          {'conv5_5_CPM_L1': [512, 8, 1, 1, 0]}]#38⇒8

    blocks['block1_2'] = [{'conv5_1_CPM_L2': [128, 128, 3, 1, 1]},
                          {'conv5_2_CPM_L2': [128, 128, 3, 1, 1]},
                          {'conv5_3_CPM_L2': [128, 128, 3, 1, 1]},
                          {'conv5_4_CPM_L2': [128, 512, 1, 1, 0]},
                          {'conv5_5_CPM_L2': [512, 5, 1, 1, 0]}]#19⇒4 5に修正 背景あるので

    # Stages 2 - 6
    for i in range(2, 7):
        blocks['block%d_1' % i] = [
            {'Mconv1_stage%d_L1' % i: [141, 128, 7, 1, 3]},#185⇒141
            {'Mconv2_stage%d_L1' % i: [128, 128, 7, 1, 3]},
            {'Mconv3_stage%d_L1' % i: [128, 128, 7, 1, 3]},
            {'Mconv4_stage%d_L1' % i: [128, 128, 7, 1, 3]},
            {'Mconv5_stage%d_L1' % i: [128, 128, 7, 1, 3]},
            {'Mconv6_stage%d_L1' % i: [128, 128, 1, 1, 0]},
            {'Mconv7_stage%d_L1' % i: [128, 8, 1, 1, 0]}#38⇒8
        ]

        blocks['block%d_2' % i] = [
            {'Mconv1_stage%d_L2' % i: [141, 128, 7, 1, 3]},
            {'Mconv2_stage%d_L2' % i: [128, 128, 7, 1, 3]},
            {'Mconv3_stage%d_L2' % i: [128, 128, 7, 1, 3]},
            {'Mconv4_stage%d_L2' % i: [128, 128, 7, 1, 3]},
            {'Mconv5_stage%d_L2' % i: [128, 128, 7, 1, 3]},
            {'Mconv6_stage%d_L2' % i: [128, 128, 1, 1, 0]},
            {'Mconv7_stage%d_L2' % i: [128, 5, 1, 1, 0]}#19⇒4 5に修正 背景あるので
        ]
